/**
 * Benchmarks — the wire types of prism-service's /benchmark API.
 *
 * A copy of prism-service src/types/benchmark.ts (the service's docs:
 * docs/benchmarks.md); keep the two in step when either changes.
 */
