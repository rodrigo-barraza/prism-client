...
const LOGOS = {
  ...
  google: (size: number) => (
    ...
    >
      ...
      <path
        ...
        fill="oklch(0.627 0.17 145)"
      />
      <path
        d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"
        fill="oklch(0.769 0.177 90.046)"
      />
      <path
        d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
        fill="oklch(0.585 0.22 25)"
      />
    </svg>
  ),
    ...
    >
      <defs>
        <linearGradient id="lm-studio-linear-gradient" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="oklch(0.606 0.25 293.528)" />
          <stop offset="100%" stopColor="oklch(0.45 0.2 290)" />
        </linearGradient>
      </defs>
  ...
  ollama: (size: number) => (
    ...
    >
      ...
      <circle
        ...
        cy="10"
        r="1.2"
        fill="var(--background-primary, oklch(0.18 0.03 260))"
      />
      <circle
        cx="14.5"
        cy="10"
  ...
  sglang: (size: number) => (
    <svg
      ...
      style={{ flexShrink: 0 }}
    >
      {/* SGLang monogram — "SG" in a rounded frame */}
      <rect
        x="1.5"
        y="1.5"
        width="21"
