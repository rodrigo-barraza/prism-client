...
interface WorkflowComponentProps {
  ...
  onSelectNode?: (_nodeId: string | null) => void;
  nodeStatuses?: Record<string, string>;
  nodeResults?: Record<string, NodeResult | null | undefined>;
  onUpdateNodePosition?: (_nodeId: string, _position: { x: number; y: number }) => void;
  onDeleteNode?: (_nodeId: string) => void;
  onAddConnection?: (_connection: { sourceNodeId: string; sourceModality: string; targetNodeId: string; targetModality: string }) => void;
  ...
  onUpdateFileInput?: (_nodeId: string, _fileData: string | ArrayBuffer | null, _mimeType: string | null) => void;
  onDuplicateNode?: (_node: WorkflowNode) => void;
  workflows?: Workflow[];
