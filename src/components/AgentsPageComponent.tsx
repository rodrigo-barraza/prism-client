...
interface AgentsPageComponentProps {
  showSidebar: boolean;
...
export default function AgentsPageComponent({
  ...
  const fetchInitialData = useCallback(async () => {
    ...
    try {
      ...
      // Default selection to first built-in agent if nothing selected
  ...
  return (
    <>
      {/* ── Left Sidebar View ── */}
      <aside
        className={`${styles["agents-sidebar-panel"]} ${!showSidebar ? styles["is-sidebar-hidden"] : ""}`}
            ...
            {builtInAgents.map((agent) => {
              ...
              return (
                <button
                  ...
                  onClick={() => handleSelectAgent(agent.id, false)}
                >
                  <BadgeComponent
                    type="agent"
                    agent={{
              ...
              customAgents.map((agent) => {
                ...
                return (
                  <button
                    ...
                    className={`${styles["agent-card-item"]} ${isSelected ? styles["is-selected-state"] : ""}`}
                    onClick={() => handleSelectAgent(String(agent._id), true)}
                  >
                    <BadgeComponent
                      type="agent"
                      agent={{
          ...
          >
                ...
                {curatedIconOptions.map((iconOption) => {
                  ...
                  return (
                    <button
                      ...
                      onClick={() => updateField("icon", iconOption.name)}
                ...
                {curatedAccentColors.map((colorOption) => {
                  ...
                  return (
                    <button
                      ...
                      data-is-selected={isSelected}
                      onClick={() => updateField("color", isSelected ? "" : colorOption.hex)}
            ...
            <div className={styles["form-group-container"]}>
              ...
              <TextAreaComponent
                ...
                onChange={(event: React.ChangeEvent<HTMLTextAreaElement>) =>
                  updateField("guidelines", event.target.value)
                }
            ...
            <div className={styles["form-group-container"]}>
              ...
              <TextAreaComponent
                ...
                onChange={(event: React.ChangeEvent<HTMLTextAreaElement>) =>
                  updateField("toolPolicy", event.target.value)
                }
            ...
            <div className={styles["form-group-container"]}>
              ...
              <div className={styles["toggle-row-container"]}>
                ...
                <ToggleComponent
                  ...
                  onChange={(checked: boolean) => updateField("usesDirectoryTree", checked)}
                />
              </div>
              ...
              <div className={styles["toggle-row-container"]}>
                ...
                <ToggleComponent
                  ...
                  onChange={(checked: boolean) => updateField("usesCodingGuidelines", checked)}
                />
              </div>
            </div>
            ...
            <ToolSelectionComponent
              ...
              onEnabledToolsChange={(selectedTools: string[]) =>
                updateField("enabledTools", selectedTools)
              }
            ...
            <div className={styles["form-group-container"]}>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  updateField("policies", [...(editingAgent.policies || []), newPolicy]);
                }}
              >
          ...
          <div className={styles["form-layout-container"]}>
            ...
            <div className={styles["form-actions-footer"]}>
              <ButtonComponent
                ...
                onClick={() => handleDuplicateAgent(selectedBuiltInAgent)}
              >
