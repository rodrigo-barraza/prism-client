...
// (projects.json → PRISM_SERVICE_PUBLIC_URL, PRISM_WEBSOCKET_PUBLIC_URL).
//
...
const RAW_WEBSOCKET_URL =
  process.env.NEXT_PUBLIC_PRISM_WEBSOCKET_URL ||
  process.env.PRISM_WEBSOCKET_URL ||
  process.env.NEXT_PUBLIC_PRISM_WS_URL ||
  process.env.PRISM_WS_URL;
const RAW_TOOLS_URL =
...
const PUBLIC_WEBSOCKET_URL =
  process.env.NEXT_PUBLIC_PRISM_WEBSOCKET_PUBLIC_URL ||
  process.env.PRISM_WEBSOCKET_PUBLIC_URL ||
...
function resolveWebsocketUrl() {
  if (!IS_BROWSER) return RAW_WEBSOCKET_URL;
  if (IS_PRODUCTION && PUBLIC_WEBSOCKET_URL) return PUBLIC_WEBSOCKET_URL;
  return RAW_WEBSOCKET_URL;
}
